...
function Dashboard() {
  return (
    ...
    >
      ...
      {/* Forms */}
      <SectionTitle emoji="" title="Formularios" />
      <Grid>
        <ComponentCard
          name="Button"
          description="Botones con variantes y estados"
          path="components-button"
        />
        <ComponentCard
          name="Input"
          description="Campos de texto con iconos"
          path="components-input"
        />
        <ComponentCard
          name="Textarea"
          description="Área de texto expandible"
        ...
        <ComponentCard
          name="Form"
          description="Layouts de formulario"
          path="components-form"
        />
      </Grid>

      {/* Data */}
      <SectionTitle emoji="" title="Datos y Display" />
      <Grid>
        <ComponentCard
          name="Table"
        ...
        <ComponentCard
          name="Card"
          description="Contenedor composable"
        ...
        <ComponentCard
          name="Chip"
          description="Tags removibles"
          path="components-chip"
        />
        <ComponentCard
          name="Avatar"
          description="Fotos de usuario con grupo"
        ...
        <ComponentCard
          name="Alert"
          description="Mensajes contextuales"
          path="components-alert"
        />
      </Grid>

      {/* Nav */}
      <SectionTitle emoji="" title="Navegación" />
      <Grid>
        <ComponentCard
          name="Header"
        ...
        <ComponentCard
          name="Sidebar"
          description="Menú lateral colapsable"
          path="components-sidebar"
        />
        <ComponentCard
          name="Tabs"
          description="Pestañas con variantes"
        ...
        <ComponentCard
          name="Pagination"
          description="Paginación de datos"
          path="components-pagination"
        />
      </Grid>

      {/* Overlays */}
      <SectionTitle emoji="" title="Overlays" />
      <Grid>
        <ComponentCard
          name="Modal"
          description="Diálogos modales"
      ...
      {/* Filters */}
      <SectionTitle emoji="" title="Filtros" />
      <Grid>
        <ComponentCard
          name="FilterButton"
          description="Botón con popover de filtros"
          path="components-filter"
        />
        <ComponentCard
          name="FilterSelect"
          description="Dropdown filtrable"
          path="components-filter"
        />
        <ComponentCard
          name="FilterDate"
        ...
        <ComponentCard
          name="FilterSearch"
          description="Búsqueda con debounce"
          path="components-filter"
        />
        <ComponentCard
          name="FilterChips"
          description="Multi-select con chips"
          path="components-filter"
        />
      </Grid>

      {/* Templates */}
      <SectionTitle emoji="" title="Templates y Páginas" />
      <Grid>
        <ComponentCard
          name="Login"
        ...
        <ComponentCard
          name="CreditCard"
          description="Tarjeta interactiva 3D"
          path="components-interactivecreditcard"
        />
        <ComponentCard
          name="PaymentForm"
          description="Selector de método de pago"
          path="components-paymentmethodcard"
        />
      </Grid>
